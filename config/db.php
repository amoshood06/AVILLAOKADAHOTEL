...
function getDbConnection(): ?PDO
{
    ...
    // $dbName = 'avillaok_hotel_booking';  // Your database name
    // $dbUser = 'avillaok_hotel_booking';         // Your database username
    // $dbPass = 'avillaok_hotel_booking';     // Your database password
    // $charset = 'utf8mb4';
